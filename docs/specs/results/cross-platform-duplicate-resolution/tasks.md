...
- **Status:** in-progress — **13 of 15 done.** T-11 `[~]` (owner-parked for manual validation); **T-15 next eligible**, then T-14. `apply` against real data still blocked by OQ-7, OQ-8, OQ-11 and T-11.
