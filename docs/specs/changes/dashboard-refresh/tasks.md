...
- **Done:** targeted jest green after reds; `npm run build`; spec-tsc = 942 (HEAD baseline re-measured 2026-08-25); bare eslint. **Disqualifier:** a spy-only assert on the component without the service-level HTTP re-issue test proves nothing (KZ-001).
- Skills: `angular-developer`, `tdd` · Effort: medium · Deps: none · **Status:** done
