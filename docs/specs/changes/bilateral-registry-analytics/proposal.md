...
| VR-7 | **Geographic footprint** card: countries shaded by projects or budget, impl ⇄ benefit toggle | More views grid | `changes/leaflet-geo-map` (done, archived 2026-08-23 → `docs/specs/archive/2026-08-23-changes--leaflet-geo-map/`) delivers exactly this shape per contract; the impl⇄benefit toggle is a portfolio-data concept we lack |
