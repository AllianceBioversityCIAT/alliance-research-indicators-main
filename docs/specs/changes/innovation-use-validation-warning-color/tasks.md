...
- [ ] `AR-1`'s follow-up design-system ticket is filed.
- [ ] Actuals compared against the budget (3 tasks / ~40 LOC / 1 round); any overrun escalated, not absorbed.
