...
- [x] **Covers:** R-DCR-001 (Mapped flows: all AND/BUT clauses; Degrade: all clauses) · **Design:** §2.1, §4, §5, §6, DD-1/DD-9 · **Skills:** `nestjs-expert` · **Effort:** medium · **Size:** ~200 LOC
...
- [x] **Covers:** R-DCR-003 (Correspondence: value-mapped ramp both themes, AND label contrast config [labels outside bars], BUT rank colors removed from this card) + R-DCR-004 (Axis: hideOverlap/splitNumber, AND 3-digit case; Help buttons: grid.top reserve, BUT help behavior untouched) + R-DCR-005 token clauses · **Design:** §7.3, DD-6/DD-7 · **Skills:** `angular-developer`, `ui-ux-pro-max` · **Effort:** medium · **Size:** ~90 LOC
