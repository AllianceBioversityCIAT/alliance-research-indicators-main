...
| Pivot | **T-01, 2026-08-14** — the harness needs a fourth piece (baseline schema) the original design did not identify. Ruled by the user in favour of the dump option. See [`./execution.md`](./execution.md) → *Pivot Record: T-01* · **T-01b, 2026-08-14** — the migration history is not replayable from empty; the harness switched from replay to a schema-only snapshot. See `execution.md` → *Pivot Record: T-01b* *(added 2026-08-18, W-6 — omitted from this register on first entry though `:129` and DD-5 already attribute themselves to it)* · **T-02, 2026-08-14** — the repair activates a latent 1451 in the delete routine; companion migration added as §3.1 / DD-6 / R-SPV-002. See *Pivot Record: T-02* |
