...
**Count:** 18 rows — **17 verified**, **1 `UNVERIFIED`** (P-14b, Impact **High**; none Low). *Derived by counting the table below, never restated from an earlier draft (KZ-005).*
