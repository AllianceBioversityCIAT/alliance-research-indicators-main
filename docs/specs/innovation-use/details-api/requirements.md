...
- [ ] AC.3 — Every new handler declares `@ApiTags`, `@ApiBearerAuth`, `@ApiOperation`, and `@ApiBody` where it takes a body — **verified by human inspection of `/swagger`** (§5.3).
