...
- **Done:**
  - [ ] Order is eyebrow, title, **description**, metadata row
  - [ ] Row reads `[status] · Innovation Dev level → n · Reporting year → y · Geographic scope → s`
  - [ ] A null field contributes **no element and no stranded separator**
