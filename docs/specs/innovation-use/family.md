...
| --- | --- | --- | --- | --- | --- |
| 1 | Data model, catalog & green check | `docs/specs/innovation-use/data-model-and-catalog/` | **`bugfix/sp-versioning-roles-id`** (external — ⚠️ **archived 2026-08-18 but NOT merged**; see [`../archive/2026-08-18-bugfix--sp-versioning-roles-id/archive-summary.md`](../archive/2026-08-18-bugfix--sp-versioning-roles-id/archive-summary.md)) | no | pending |
