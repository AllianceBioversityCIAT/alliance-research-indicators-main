...
| --- | --- | --- | --- | --- | --- |
| 1 | Data model, catalog & green check | `docs/specs/innovation-use/data-model-and-catalog/` | **`bugfix/sp-versioning-roles-id`** — archived 2026-08-18; its two repair migrations are **committed on this branch and ordered before M6**, so the dependency is **satisfied by construction** (corrected 2026-08-18; see [`archive-summary.md`](../archive/2026-08-18-bugfix--sp-versioning-roles-id/archive-summary.md)) | no | **in progress — T-01…T-09 done** |
