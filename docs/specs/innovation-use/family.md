...
> was to sync this row to reality, and that is what was done. The cell will read `done` when T-12 is
> closed, the migrations are applied, and the chunk is archived.
