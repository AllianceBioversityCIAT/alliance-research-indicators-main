...
- **Status:** done · **11 of 11 discharged 2026-08-26** — the four human criteria closed at the HITL gate (`c8` by explicit user ruling with its coverage gap recorded; see `execution.md`) · **Size:** M · **Dependencies:** T-09, T-10, T-12, **T-14**
