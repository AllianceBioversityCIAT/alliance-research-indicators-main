...
export class AiMetadataRepository {
    ...
    constructor(private readonly dataSource: DataSource) {
        this.bulkUploadProcessesRepository = this.dataSource.getRepository(BulkUploadProcesses);
        this.bulkUploadResultsRepository = this.dataSource.getRepository(BulkUploadResults);
    }
