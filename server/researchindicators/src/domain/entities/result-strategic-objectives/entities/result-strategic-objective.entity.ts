...
export class ResultStrategicObjective extends AuditableEntity {
    ...
    @ManyToOne(() => StrategicObjective, (strategicObjective) => strategicObjective.resultStrategicObjectives)
    @JoinColumn({ name: 'strategic_objective_id' })
    strategic_objective: StrategicObjective;

    @ManyToOne(() => ResultStrategicObjectiveRoles, (resultStrategicObjectiveRoles) => resultStrategicObjectiveRoles.resultStrategicObjectives)
