...
export class ResultImpactOutcome extends AuditableEntity {
    ...
    @ManyToOne(() => ImpactOutcome, (impactOutcome) => impactOutcome.resultImpactOutcomes)
    @JoinColumn({ name: 'impact_outcome_id' })
    impact_outcome: ImpactOutcome;

    @ManyToOne(() => ResultImpactOutcomeRoles, (resultImpactOutcomeRoles) => resultImpactOutcomeRoles.resultImpactOutcomes)
