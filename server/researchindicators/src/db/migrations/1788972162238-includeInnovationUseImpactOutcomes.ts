...
// [SPEC changes/add-strategic-outcomes-field] Widens alignment_validation's
// Portfolio-2 impact_outcomes-required branch from result_indicator = 5
// (OICR only) to result_indicator in (4, 5, 6) (OICR, Policy Change,
// Innovation Use). up() is 1783021729548-UpdateAlignmentValidation's up()
// body verbatim with that single line changed; down() reuses that same
// up() body verbatim and unchanged, restoring today's OICR-only behavior
// on revert.
export class IncludeInnovationUseImpactOutcomes1788972162238
...
begin
	            ...
	            elseif (portfolio_id = 2) then
	            	...
	            	if result_indicator in (4, 5, 6) then
