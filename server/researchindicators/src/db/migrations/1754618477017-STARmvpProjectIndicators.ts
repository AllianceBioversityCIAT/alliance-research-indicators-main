...
export class STARmvpProjectIndicators1754618477017
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`project_groups\` ADD CONSTRAINT \`FK_a24395de4ce13155d65f3a439b7\` FOREIGN KEY (\`parent_group_id\`) REFERENCES \`project_groups\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`project_groups\` DROP FOREIGN KEY \`FK_a24395de4ce13155d65f3a439b7\``,
    );
    await queryRunner.query(
